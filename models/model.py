...
T = TypeVar('T', bound='Model') # A custom data type for Model.  This helps PyCharm intellisense pass through the
# subclass's data type
...
class Model(metaclass=ABCMeta):
    ...
    @classmethod # Example use Item.find_one_by('url', 'https://bla.com')
